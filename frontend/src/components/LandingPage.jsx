 ...
 * Main landing page with app description and call-to-action
 * @component
 */
...
/**
 * Renders the landing page with app introduction and sign-up button
 * Features a hero section with image and descriptive text about the Job Manager app
