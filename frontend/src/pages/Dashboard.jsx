/**
 * Dashboard Page
 * Main dashboard for authenticated users to view and manage their jobs
 * @component
 */
...
/**
 * Renders the dashboard with job creation form and job cards
 * Features:
 * - Navigation bar with logout functionality
 * - Form to add new jobs (company and position)
 * - Grid display of all user's jobs as cards
...
const Dashboard = () => {
  ...
  /**
   * Handles user logout by removing token and redirecting to home
   */
  const handleLogout = () => {
